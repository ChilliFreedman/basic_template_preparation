...
# ---------------------------------------------
# בדיקה אוטומטית של CRUD על הקונסול
# ---------------------------------------------
if __name__ == "__main__":
    ...
    # CREATE
    print("\n--- CREATE ---")
    item1 = {"id": 1, "name": "דוגמה 1", "description": "תיאור 1"}
    item2 = {"id": 2, "name": "דוגמה 2", "description": "תיאור 2"}
    ...
    # UPDATE
    print("\n--- UPDATE (id=1) ---")
    updated_item = {"id": 1, "name": "דוגמה 1 - מעודכן", "description": "תיאור חדש"}
    ...
    # ניתן להמשיך להריץ את השרת אם רוצים לבדוק ב-Swagger
    import uvicorn
